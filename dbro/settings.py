# Django settings for dbro project.
...
if DEPLOY:
    DATABASES = {
        'default': {
            ...
            'USER': secrets.DB_USERNAME,                      # Not used with sqlite3.
...
if DEPLOY:
    STATICFILES_DIRS = (secrets.PROD_STATICFILES_DIR,)
else:
    STATICFILES_DIRS = (secrets.DEV_STATICFILES_DIR,)
...
SECRET_KEY = 'ii%0-ir6cpn99nh9p6_k7vgl0-_b!10=a^xg2qw+x+_0ns9j-2'
...
ROOT_URLCONF = 'dbro.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'dbro.wsgi.application'
